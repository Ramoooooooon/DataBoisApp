...
export default class Headphone1 extends Component{
    constructor(props){
        super(props);
        this.state={
            ProductName:"WH-XB900N Wireless Noise Canceling Headphones",
            ActualPrice: 7499,
            Price:"P 7,499",
        }
    }
        ...
        return(
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <ImageBackground source={require("../../assets/Product/Headphone1.png")} style={{height: 400, width: "100%"}}>
                    ...
                    <View style={{height: 205, width:"100%",padding: 15,}}>
                        ...
                        <Text style={styles.productHeadCount}>With exceptional bass and advanced noise cancelation, WH-XB900N headphones put the focus firmly on the music. Let your party for one begin.</Text>
                    </View>
                </ScrollView>
                <View style={{height: 50, width: "100%",justifyContent:"center", padding:30,}}>
                    <Text style={styles.productHead}>{this.state.Price}</Text>
                    <Text style={styles.productHeadCount}>Tax Rate 2% - P89.95 (P1,588.95)</Text>
                </View>
