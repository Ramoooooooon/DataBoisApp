        ...
        return(
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <ImageBackground source={require("../../assets/Product/Arduino.png")} style={{height: 400, width: "100%"}}>
                    ...
                    <View style={{height: 205, width:"100%",padding: 15,}}>
                        ...
                        <Text style={styles.productHeadCount}>*UNO R3 ATmega328P CH340G compatible with Arduino</Text>
                        <Text style={styles.productHeadCount}>This UNO R3 ATmega328P CH340G version is optimized in the original version to ensure consistent and compatible with the original, but also easy to use.</Text>
                    </View>
                </ScrollView>
                <View style={{height: 50, width: "100%",justifyContent:"center", padding:30,}}>
                    <Text style={styles.productHead}>{this.state.Price}</Text>
                    <Text style={styles.productHeadCount}>Tax Rate 2% - P89.95 (P589.95)</Text>
                </View>
