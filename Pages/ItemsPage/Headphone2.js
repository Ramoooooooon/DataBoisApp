...
export default class Headphone2 extends Component{
    constructor(props){
        super(props);
        this.state={
            ProductName:"Cat Ear Headphones VZV23/ VIV23M Wireless Headphone",
            ActualPrice: 699,
            Price:"P 699",
        }
    }
        ...
        return(
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <ImageBackground source={require("../../assets/Product/Headphone2.png")} style={{height: 400, width: "100%"}}>
                    ...
                    <View style={{height: 205, width:"100%",padding: 15,}}>
                        ...
                        <Text style={styles.productHeadCount}>We offer you these cat ear headphones to be always in line with the latest trends. Ultramodern headphones design with cat ears shape is something all the young people want to have these days.</Text>
                    </View>
                </ScrollView>
                <View style={{height: 50, width: "100%",justifyContent:"center", padding:30,}}>
                    <Text style={styles.productHead}>{this.state.Price}</Text>
                    <Text style={styles.productHeadCount}>Tax Rate 2% - P89.95 (P788.95)</Text>
                </View>
